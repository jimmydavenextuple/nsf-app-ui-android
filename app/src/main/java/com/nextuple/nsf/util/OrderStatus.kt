...
enum class OrderStatus(
	...
	BEING_PACKED(statusText = "Being Packed", statusColor = BrandColor.BLUE_300_NT, iconDrawable = R.drawable.ic_pack),
	STAGE(statusText = "Stage", statusColor = BrandColor.PINK_NT, iconDrawable = R.drawable.ic_stage),
	BEING_STAGED(statusText = "Being Staged", statusColor = BrandColor.BLUE_300_NT, iconDrawable = R.drawable.ic_stage),
